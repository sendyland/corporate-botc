...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-12">
                    ...
                    <h5 class="card-title">Payment Peserta Course</h5>
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="mb-0">
                        ...
                        <div class="row mt-2 form-action">
                            <form id="approveForm"
                                action="{{ route('course-order.update_payment', $courseRegistration->id) }}"
                                method="POST">
                                @csrf
                                @method('PUT') <!-- Tambahkan method PUT untuk update -->
                                <input type="hidden" name="status" value="1">
                                <a href="{{ route('course-order.index') }}" class="btn btn-warning">Kembali</a>
                                <button type="button" class="btn btn-primary" onclick="confirmApprove()">Approve
                                    Payment</button>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        function confirmApprove() {
            Swal.fire({
                title: 'Are you sure?',
                text: "You want to approve payment this registration!",
                icon: 'warning',
